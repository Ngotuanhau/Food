...
const data = [
    {
        ...
        image: require('../../../HinhAnh/Sanpham/Pizza/chicago.jpg'),
...

    {
        id: 1,
        title: 'Detroit Style',
        image: require('../../../HinhAnh/Sanpham/Pizza/detroi.jpg'),
        backgroundColor: '#C62828'
    },

    {
        id: 2,
        title: 'New England Greek',
        image: require('../../../HinhAnh/Sanpham/Pizza/england.jpg'),
...

    {
        ...
        image: require('../../../HinhAnh/Sanpham/Pizza/newyork.jpg'),
                ...
                <View style={{ width: width, height: 250 }}>
                    ...
                    <Swiper style={styles.banner}
                        ...
                        <View style={styles.slide}>
                            <Image source={require('../../../HinhAnh/Sanpham/Pizza/baner1.jpg')}
                                style={styles.imageStyle} />
                        </View>
                        <View style={styles.slide}>
                            <Image source={require('../../../HinhAnh/Sanpham/Pizza/baner2.jpg')}
                                style={styles.imageStyle} />
                        </View>
                        <View style={styles.slide}>
                            <Image source={require('../../../HinhAnh/Sanpham/Pizza/baner3.jpg')}
                                style={styles.imageStyle} />
                        </View>
